...
public class Md5Utils {
	...
	public static void main(String[] args) {
		String str = "ershjx7887";
		String md5_str = encodePassword(str);
		System.out.println("加密密码=" + md5_str);
		String salt = "zhxm"; // 混淆码
		String md5_str_hx = encodePassword(str, salt);
		System.out.println("混淆密码=" + md5_str_hx);

		String str_md5_16 = encryptMD5(str, 16);
		// String str_md5_32 = encryptMD5(str, 32);
		 System.out.println("md5加密后16位字符串：" + str_md5_16);
		// System.out.println("md5加密后32位字符串：" + str_md5_32);
		// System.out.println("32位密码转换成16位密码："
		// + getMd5Str32to16("C33367701511B4F6020EC61DED352059"));
		// String str_md5_32_rest = encryptMD5_Reset(str, 32);
		// System.out.println("重组md5加密后32位字符串：" + str_md5_32_rest);
